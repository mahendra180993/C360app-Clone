		...
		<div class="container">
			<div class="row ">
				<div class="col-md-3 col-sm-3">
					<a href="index.html"> 
					<img src="images/logo.png" alt="C360soft" title="C360soft" class="logo stickylogo" width="auto" height="auto"/> 
					<img src="images/logowhite.png" alt="C360soft" title="C360soft" class="logo staticlogo" width="auto" height="auto"/></a>
				</div>
				<div class="col-md-9 col-sm-9 text-right d-flex align-items-center">
					<div class="collapse nav navbar-collapse" id="navbar-collapse">
					  <ul class="mainmenu ">
						...
						<li class=""><a href="careers.html" class="">Careers</a></li>
						<li class=""><a href="aboutus.html#" class="">About C360 </a></li>
						<li class="getlink"><a href="#" >Get Started</a></li>
						{/* <a href="#" class="" data-toggle="modal" data-target="#get_trained"></a> (Get Started tag)*/}
					  </ul>
					</div>
				  </div>
			</div>
	...
	<div class="herobanner">
		<div class="container">
			<div class="show-on-scroll">
				{/* <div class="heading"> */}
					<h1 class=" ">
                    <div class="globe zoom"> <img src="https://www.c360soft.ai/images/world.svg" class="" alt="C360 soft" title="C360 soft" width="1920" height="556"/> </div>
 								The Future of<br></br>
 							<span> AI </span> Is here </h1>
					<p><a href="#" class="" >Get In Touch</a> </p>
					{/* <a href="#" class="" data-toggle="modal" data-target="#get_trained">Get In Touch</a> (*/}
				{/* </div> */}
			</div>
		</div>
